 ...
 */
;(function(factory) {if (typeof exports === 'object' && typeof module !== 'undefined') {module.exports = factory(require('jquery'), window, document);} else {factory(window.Zepto || window.jQuery, window, document);}})(function(jQuery, window, document, undefined) {'use strict';/**
 * Owl carousel
 * @version 2.3.4
